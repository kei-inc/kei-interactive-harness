...
`pnpm add -D husky github:kei-inc/kei-interactive-harness#v1.2.0`, and in a pnpm
...
`pnpm add -D husky github:kei-inc/kei-interactive-harness#v1.2.0`. In a pnpm
...
```bash
npm i -D github:kei-inc/kei-interactive-harness#v1.2.0
npx harness sync

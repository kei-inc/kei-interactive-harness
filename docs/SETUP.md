...
`pnpm add -D husky github:kei-inc/kei-interactive-harness#v1.3.1`, and in a pnpm
...
`pnpm add -D husky github:kei-inc/kei-interactive-harness#v1.3.1`. In a pnpm
...
```bash
npm i -D github:kei-inc/kei-interactive-harness#v1.3.1
npx harness sync

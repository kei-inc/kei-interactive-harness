...
cd my-app
npm i -D husky github:kei-inc/kei-interactive-harness#v1.8.0
npx harness init
npx harness ratchet
```

With pnpm, the install line is
`pnpm add -D husky github:kei-inc/kei-interactive-harness#v1.8.0`, and in a pnpm
...
`pnpm add -D husky github:kei-inc/kei-interactive-harness#v1.8.0`. In a pnpm
...
```bash
npm i -D github:kei-inc/kei-interactive-harness#v1.8.0
npx harness sync

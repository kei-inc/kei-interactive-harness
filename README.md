...
npm i -D github:kei-inc/kei-interactive-harness#v1.3.0 && npx harness sync   # the new tag
...
- **GitHub directly**, no registry: `npm i -D github:kei-inc/kei-interactive-harness#v1.3.0`. Pin by
